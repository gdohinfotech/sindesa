        ...
        <div class="col-md-12">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <div class="btn-group">
                        <a href="{{ route('admin.keluarga.add') }}" type="button" class="btn btn-primary btn-sm btn-social btn-block"><i class="fa fa-plus"></i>Tambah KK baru</a>
                    </div>
                    <div class="btn-group">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item btn-sm btn-social" href="{{ route('admin.keluarga.anggota') }}"><i class="fas fa-list-ol"></i>Anggota Keluarga</a>
                                    <a class="dropdown-item btn-sm btn-social" href=""><i class="fas fa-plus"></i>Tambah Anggota</a>
