        ...
        <div class='col-sm-12'>
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <div class="btn-group">
                        <a href="{{ route('admin.keluarga.index') }}" type="button" class="btn btn-primary btn-sm btn-social btn-block"><i class="fas fa-arrow-left"></i>Kembali ke Daftar Keluarga</a>
                    </div>
                </div>
                <!-- data identitas desa -->
                <div class="card-body">
                    <div class='col-sm-7'>
                        <div class='form-group'>
                            ...
                            <input id="no_kk"  name="no_kk"  class="form-control input-sm nik" type="text" placeholder="Nomor KK"  value=""></input>
                        </div>
                    </div>
                </div>
            </div>
